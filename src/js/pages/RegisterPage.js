              ...
              <div className="row" data-spIf="!account.created">
                <div className="col-xs-12">
                  <div className="form-horizontal">
                    ...
                    <div className="form-group">
                      <label htmlFor="customData.role" className="col-xs-12 col-sm-4 control-label">Role</label>
                      <div className="col-xs-12 col-sm-4">
                        <input type="text" className="form-control" id="customData.role" name="customData.role" placeholder="Role (user/admin)" />
                      </div>
                    </div>
